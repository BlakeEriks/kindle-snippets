...
const NewBookDialogue = ({ book, setBook }: NewBookDialogueProps) => {
    ...
    <>
      ...
      <div className='flex items-center mt-4'>
        ...
        <Select
          ...
          style={{ flex: 1 }}
          onChange={(id: number) =>
            setBook({ ...book, author: allAuthors.data?.find(author => author.id === Number(id)) })
          }
            ...
            <div>
              ...
              <Space style={{ padding: '0 8px 4px' }}>
                ...
                <Button
                  type='text'
                  icon={<PlusOutlined />}
                  onClick={() => saveAuthor({ name: newAuthor })}
                >
                  Add Author
                </Button>
              </Space>
